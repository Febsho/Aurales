...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  movieMetadataFallback: localStorage.getItem('orynt_movie_meta_fb') !== 'false',
  seriesMetadataFallback: localStorage.getItem('orynt_series_meta_fb') !== 'false',
  animeMetadataFallback: localStorage.getItem('orynt_anime_meta_fb') !== 'false',
  ...
  includeAnimeSpecials: localStorage.getItem('orynt_include_anime_specials') !== 'false',
